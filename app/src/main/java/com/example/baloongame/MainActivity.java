...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lottieArray = new LottieAnimationView[]{animationView1,animationView2,animationView3,animationView4,animationView5,animationView6,animationView7,animationView8
        ,animationView9};
